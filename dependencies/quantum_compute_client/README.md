# Rust API client for Quantum Compute Service API

The Quantum Compute Service API description
...
Put the package under your project folder in a directory named `dependencies/quantum_compute_client` and add the following to `Cargo.toml` under `[dependencies]`:

```
quantum_compute_client = { path = "dependencies/quantum_compute_client" }
```
