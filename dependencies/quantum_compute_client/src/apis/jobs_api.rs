...
pub async fn cancel_job_jid(
    ...
    let p_path_id = id;
    let p_header_parent_job_id = parent_job_id;
    ...
    if let Some(param_value) = p_header_parent_job_id {
...
pub async fn get_job(
    ...
    let p_path_id = id;
    let p_header_ibm_api_version = ibm_api_version;
    let p_query_exclude_params = exclude_params;
    ...
    if let Some(ref param_value) = p_query_exclude_params {
...
pub async fn list_jobs(
    ...
    if let Some(ref param_value) = p_query_program {
...
pub async fn replace_job_tags(
    ...
    let p_path_id = id;
    let p_header_ibm_api_version = ibm_api_version;
    let p_body_replace_job_tags_request = replace_job_tags_request;
    ...
    req_builder = req_builder.json(&p_body_replace_job_tags_request);
