...
/// RemoteStorageResults : Location for where job results will be stored (omitted properties will will be inherited from default remote storage option)
...
impl RemoteStorageResults {
    /// Location for where job results will be stored (omitted properties will will be inherited from default remote storage option)
    pub fn new(
        region: String,
