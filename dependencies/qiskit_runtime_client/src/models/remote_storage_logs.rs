...
/// RemoteStorageLogs : Location for where job logs will be stored (omitted properties will will be inherited from default remote storage option)
...
impl RemoteStorageLogs {
    /// Location for where job logs will be stored (omitted properties will will be inherited from default remote storage option)
    pub fn new(
        region: String,
