...
pub struct GetAccessTokenResponse {
    // The IAM access token that can be used to invoke Quantum System API. Use this token with the prefix Bearer in the HTTP header Authorization for invocations of Quantum System API.
