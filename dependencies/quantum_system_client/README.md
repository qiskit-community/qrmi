# Quantum System API Client for Rust
...
```
API document will be created under `../target/doc/quantum_system_api` directory. 
...
The quantum_system_api crate defines some [Cargo features](https://doc.rust-lang.org/cargo/reference/manifest.html#the-features-section) to enable using Quantum System Client for Rust in a variety of freestanding environments.
...
Allow clients to specify IBM-API-Version HTTP header value while calling Quantum System API. This was removed from Direct Access API Beta specification. This is just backward compatibility. 
...
A ClientBuilder can be used to create a Client with custom configuration. Quantum System API service endpoint URL is specified as constructor arguments. You can customize the configuration by calling `with_` functions.
...
Regardless if you are part of the core team or an external contributor, welcome and thank you for contributing to Quantum System API Client for Rust!
