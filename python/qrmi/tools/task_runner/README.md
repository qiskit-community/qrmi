...
| ---- | ---- |
| QRMI_QPU_RESOURCES | Quantum backend name |
| QRMI_QPU_TYPES | Should be `ibm-quantum-system` |
...
export QRMI_QPU_RESOURCES=test_heron
...
| ---- | ---- |
| QRMI_QPU_RESOURCES | Quantum backend name |
| QRMI_QPU_TYPES | Should be `qiskit-runtime-service` |
...
export QRMI_QPU_RESOURCES=ibm_marrakesh
export QRMI_QPU_TYPES=qiskit-runtime-service
...
| Environment variables | Descriptions |
| ---- | ---- |
| QRMI_QPU_RESOURCES | Backend name |
| QRMI_QPU_TYPES | Should be `pasqal-cloud` |
...
export QRMI_QPU_RESOURCES=FRESNEL
export QRMI_QPU_TYPES=pasqal-cloud
