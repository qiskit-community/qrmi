...
| ---- | ---- |
| QRMI_JOB_QPU_RESOURCES | Quantum resource names. Comma-separated values, e.g. `FRESNEL` |
| QRMI_JOB_QPU_TYPES | Quantum resource types. Comma-separated values corresponding to each Quantum resource name specified by `QRMI_JOB_QPU_RESOURCES`.<br><br>Supported types:<ul><li>`pasqal-cloud`</li></ul> |
