...
int main(int argc, char *argv[]) {
  ...
  if (argc != 3) {
    fprintf(stderr, "felis <backend_name> <qir input file>\n");
    return EXIT_SUCCESS;
  }
  ...
  payload.ALICE_BOB_FELIS.human_qir = (char *)input;
  payload.ALICE_BOB_FELIS.input_params = input_json;
