...
//! cargo run --example qrmi-example-ibm-quantum-system-provider -- "num_qubits=127&name=ibm_*"
//!
//! # Online resources only (calls get_backend_status per resource in parallel)
//! cargo run --example qrmi-example-ibm-quantum-system-provider -- "status=online"
//!
//! # Include simulators (default excludes them)
//! cargo run --example qrmi-example-ibm-quantum-system-provider -- "is_simulator=true"
//! ```
