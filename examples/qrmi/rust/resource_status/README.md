...
```shell-session
../target/release/qrmi-example-resource-status --help
QRMI Resource status API - Example

Usage: qrmi-example-resource-status --resource-type <RESOURCE_TYPE> --resource-id <RESOURCE_ID>

Options:
  -r, --resource-type <RESOURCE_TYPE>  resource type
  -r, --resource-id <RESOURCE_ID>      resource id
  -h, --help                           Print help
...
../target/release/qrmi-example-resource-status iqm-server garnet_mock
```
